# backend/blockchain/scripts/single_read.py
...
print("State:", c.functions.electionState().call())
print("Count:", c.functions.getCandidatesCount().call())

# 🔥 ONLY ONE CALL
print("Candidate 1:", c.functions.getCandidate(1).call())
